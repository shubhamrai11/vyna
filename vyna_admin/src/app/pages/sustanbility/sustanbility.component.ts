...
@Component({
  selector: 'app-sustanbility',
  templateUrl: './sustanbility.component.html',
  styleUrls: ['./sustanbility.component.css']
})
export class SustanbilityComponent implements OnInit {
searchText: string = '';
 totalCount = 0;
  limit = 20;
  currentPage = 0;
  ...
  getUser(pageIndex: number, pageSize: number) {
    this.userService.getaboutusSustainbility(pageIndex + 1, pageSize).subscribe(
      (response: any) => {
